...
const time = moment(Date.now()).tz('Africa/Nigeria').locale('id').format('HH:mm:ss z')
    ...
    return sam.sendMessage(m.chat, {
        contextInfo: {
            ...
            externalAdReply: {
                ...
                body: `by C0D3BR34K3R`,
                previewType: "VIDEO",
                thumbnailUrl: `https://files.catbox.moe/4qxu1a.png`,
...
quotedMessage: {
                buttonsMessage: {
                    ...
                    contentText: "༑ Fail Beta - ( C0D3BR34K3R ) \"👋\"",
                    footerText: "© die?",
                    buttons: [
                        {
	           ...
	           text: caption,
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: `C0D3BR34K3R`,
                            thumbnailUrl: `https://files.catbox.moe/4qxu1a.png`, 
                            sourceUrl: `https://whatsapp.com/channel/0029VbBQODd3LdQZcDSbMf0e`,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    }
...
sam.public = true
reply("𝔇𝔞𝔯𝔨 𝔅𝔲𝔤 𝚅1 𝙸𝚂 𝙾𝙽 𝙿𝚄𝙱𝙻𝙸𝙲 𝙼𝙾𝙳𝙴")
}
break
...
let latensi = speed() - timestamp
         ...
         reply (`━━━━━━━━━━━━━━━━━\n\◉ 𝙷𝙴𝙻𝙻𝙾 ${m.pushName}\n\━━━━━━━━━━━━━━━━━\n\◈𝔇𝔞𝔯𝔨 𝔅𝔲𝔤 𝚂𝙿𝙴𝙴𝙳  : ${latensi.toFixed(4)} 𝐌𝐒\n\━━━━━━━━━━━━━━━━━`); 
         } 
 break; 
case "runtime":
                let pinga = `𝔇𝔞𝔯𝔨 𝔅𝔲𝔤 𝚅1 𝙸𝚂 𝙰𝙲𝚃𝙸𝚅𝙴 𝙵𝙾𝚁 ${runtime(process.uptime())}`
               sam.sendMessage(m.chat, {
                    text: pinga,
                    contextInfo: {
                        externalAdReply: {
...
if (!isOwner) return reply(mess.owner)
sam.public = false
reply(" *𝔇𝔞𝔯𝔨 𝔅𝔲𝔤 𝚅1 𝙸𝚂 𝙾𝙽 𝚂𝙴𝙻𝙵 𝙼𝙾𝙳𝙴*")
}
break
